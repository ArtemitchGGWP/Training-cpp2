...
int main()
{
    ...
    balance_eur = eur_change_amount - (euros * euros_value);

    fifty_cents = balance_eur / fifty_cents_value;
    balance_eur -= fifty_cents * fifty_cents_value;
    
    twenty_cents = balance_eur / twenty_cents_value;
    balance_eur -= twenty_cents * twenty_cents_value;

    ten_cents = balance_eur / ten_cents_value;
    balance_eur -= ten_cents * ten_cents_value;
    
    five_cents = balance_eur / five_cents_value;
    balance_eur -= five_cents * five_cents_value;
