...
int main()
{
    ...
    // vector <char> vowels(5); // 5 initiated to zero
    ...
    cout << "What score would you like to display?" << endl;
    int test_score_show{0};
    cin >> test_score_show;

    cout << "You displayed the score number " << test_score_show << " and it is " << test_scores.at(test_score_show - 1) << endl;
